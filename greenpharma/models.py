...
class Registration(AbstractUser):
    ...
    objects = RegistrationManager()  # ✅ attach custom manager

    class Meta:
        db_table = "registration"  # ✅ database table will be "registration"
...
class Product(models.Model):
    ...
    seller = models.ForeignKey(
        SellerProfile,   # ✅ product belongs to Seller
        on_delete=models.CASCADE,
        related_name="products",
        null=True,
        blank=True
